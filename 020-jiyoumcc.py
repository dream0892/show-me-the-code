...
import pdb
infos = []
info_file = xlrd.open_workbook('talk.xls')
...
print()
print('通信方式分类：')
for (k, v) in list(time_types.items()):
    print(K, v)
print()
print('通信类型分类：')
for (k, v) in list(time_classes.items()):
    print(K, v)
print()
print('对方号码分类：')
for (k, v) in list(time_numbers.items()):
    print(k.ljust(20), v)